...
### Update the LILA / USDA data - P2 M (If it exists)
...
### Identify the gaps - P2 L (Goes along with magnitude/need delta)
...
### Add food pantry / food bank data - P3 L (Requires outside data)
...
### Add food access points (gardens, markets, grocery, fridges, stands, ethnic markets) - P3 L (Requires outside data)
...
### Add heart disease / CAD prevalence - P3 L (Requires outside data)
...
### Other unaffiliated community ag work - P3 L (Requires outside data)
...
### Heart disease rationale *(context)* - P3 S
...
### Offer training / working session on the tool - P4 S
