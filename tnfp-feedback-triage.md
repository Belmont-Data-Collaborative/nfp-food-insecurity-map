# TNFP Food Access Tool — Feedback Triage
...
### Org categories as food-insecurity proxy
...
### LILA Designation vs. Low Income/Low Access Population filters
...
### Add food access points (gardens, markets, grocery, fridges, stands, ethnic markets)
...
### Add food pantry / food bank data
...
### Distinguish TNFP vs. non-TNFP community meal sites
...
### Add heart disease / CAD prevalence
...
### Source / map MI hospitalizations
...
### Potential additional source: TNCOMMGARD Mutual Aid Map
...
### Define "partners" and the update/maintenance plan
...
### Offer training / working session on the tool
...
### Heart disease rationale *(context)*
...
### Inform partner selection criteria
